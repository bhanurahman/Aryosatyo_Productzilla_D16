...
function filterByShop(_data, location){
    return _data.filter((d)=>{
        return d.storeLocarion === location
    })
}
...
const shop = filterByShop(data, 'Denver')
const customer = findCustomerById(data, '5bd761dcae323e45a93cd019')
console.log('shop', shop);
console.log('customer', customer);

try {
    const customer = findCustomerById(data, '5bd761dcae323e45a93cdcbdhcb');
    console.log('customer', customer);
} catch (error){
    console.log('ada error:', error.message);
} finally {
    console.log('Selesai yg pertama');
}
try {
    const cutomer = findCustomerById(data, '5bd761dcae323e45a93cd018');
    console.log('customer', customer);
} catch (error){
    console.log('ada error:', error.message);
} finally {
    console.log('Selesai yg kedua');
}
try {
    const cutomer = findCustomerById(data, '5bd761dcae323e45a93cd019');
    console.log('customer', customer);
} catch (error){
    console.log('ada error:', error.message);
} finally {
    console.log('Selesai yg Ketiga');
}